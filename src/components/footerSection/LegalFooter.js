...
const LegalFooter = () => {
  ...
  const langMapping = {
    es: {
      imgSrc: 'https://fedesconsultora.com/fedes-consultora/landing/bandera_argentina.svg',
      text: 'ES'
    },
    en: {
      imgSrc: 'https://fedesconsultora.com/fedes-consultora/landing/bandera_estados_unidos.svg',
      text: 'EN'
    }
  };
    ...
    <section className="legalFooter">
      <div className="logoEidioma">
        <img
          ...
          src="https://fedesconsultora.com/fedes-consultora/landing/logoBlanco.png"
        ...
        <div className="dropdown js_language_selector d-print-none">
          ...
          >
            <div>
              ...
              <img
                className="arrow"
                src="https://fedesconsultora.com/fedes-consultora/landing/flecha_abajo_blanca.svg"
                alt="Arrow"
                height="20"
              />
            </div>
