// src/pages/BlogPages/CreatividadInnovacion.js
...
export default function CreatividadInnovacion() {
  return (
    <ArticleLayout
      id={20} // Este ID debe coincidir con el ID en tu hoja de cálculo de Google
      blocks={bloques}
      accent="#709cbb"
    />
  );
